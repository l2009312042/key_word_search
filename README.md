...
5 添加环境变量  vi  ~/.bashrc  [PATH=$PATH:xxx/F4DE/bin  export PATH]  source ~/.bashrc   


###kws 需要准备如下3个文件 kwlist.xml 、ecf.xml 、rttm 
脚本可执行kaldi/egs/babel/s5d 
================================================================

##step1 对测试集先对齐  比如拿训练的启蒙课1为例
```
